...
const translations = {
  ...
  servingProtein:   { en: 'Protein / serving',   ko: '1회 단백질',     ja: '1回のタンパク質'     },
  per100gProtein:   { en: 'Protein / 100g',      ko: '100g당 단백질',  ja: '100gあたりのタンパク質' },
  addIntake:        { en: 'Add Intake',           ko: '섭취 추가',      ja: '摂取を追加'          },
  intakeAmount:     { en: 'Amount (g)',           ko: '섭취량 (g)',     ja: '摂取量 (g)'          },
  noSources:        { en: 'Add protein sources to track intake', ko: '소스를 추가하면 섭취량을 기록할 수 있어요', ja: 'ソースを追加して摂取量を記録しましょう' },
  proteinSourceName:{ en: 'Source name (e.g. Chicken)', ko: '소스 이름 (예: 닭가슴살)', ja: 'ソース名 (例：鶏肉)' },
  deleteSource:     { en: 'Delete this source?', ko: '이 소스를 삭제할까요?', ja: 'このソースを削除しますか？' },
