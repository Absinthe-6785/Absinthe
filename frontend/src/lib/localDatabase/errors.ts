export type LocalDatabaseErrorCode =
  ...
  | 'OUTBOX_NOT_FOUND' | 'INVALID_OUTBOX_TRANSITION' | 'LEASE_OWNER_MISMATCH' | 'LEASE_FENCE_MISMATCH'
  | 'INVALID_OUTBOX_QUERY' | 'OUTBOX_SEQUENCE_GAP' | 'OUTBOX_IDEMPOTENCY_MISMATCH'
  | 'CHECKPOINT_NOT_FOUND' | 'CHECKPOINT_REGRESSION' | 'SERVER_EPOCH_MISMATCH'
  | 'CONFLICT_NOT_FOUND' | 'WORKER_LEASE_HELD' | 'WORKER_LEASE_NOT_FOUND'
  ...
  | 'CUTOVER_SETTLEMENT_AUTHORITY_REQUIRED' | 'CUTOVER_SETTLEMENT_AUTHORITY_INVALID'
