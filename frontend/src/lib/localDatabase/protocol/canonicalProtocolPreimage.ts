...
export const PROTOCOL_PREIMAGE_DOMAINS = Object.freeze([
  ...
  'absinthe:k334:authority-evidence:v1:record-id',
  'absinthe:k334:authority-evidence:v1:canonical-digest',
  'absinthe:k334:issuer-policy:v1:record-id',
  'absinthe:k334:issuer-policy:v1:canonical-digest',
  'absinthe:k334:rollback-permission:v1:record-id',
  'absinthe:k334:rollback-permission:v1:canonical-digest',
  'absinthe:k334:termination:v1:record-id',
  'absinthe:k334:termination:v1:canonical-digest',
  'absinthe:k334:compatibility-tuple:v1:tuple-id',
  'absinthe:k334:compatibility-tuple:v1:canonical-digest',
  'absinthe:k334:external-subject-mapping:v1:record-id',
  'absinthe:k334:external-subject-mapping:v1:canonical-digest',
  'absinthe:k334:external-issuer-mapping:v1:record-id',
  'absinthe:k334:external-issuer-mapping:v1:canonical-digest',
  'absinthe:k334:conflict-observation:v1:record-id',
  'absinthe:k334:conflict-observation:v1:canonical-digest',
  'absinthe:k334:fork-observation:v1:record-id',
  'absinthe:k334:fork-observation:v1:canonical-digest',
  'absinthe:k334:subject-quarantine:v1:record-id',
  'absinthe:k334:subject-quarantine:v1:canonical-digest',
  'absinthe:k334:migration-classification:v1:record-id',
  'absinthe:k334:migration-classification:v1:canonical-digest',
  'absinthe:k334:migration-session:v1:canonical-digest',
  'absinthe:k334:migration-checkpoint:v1:canonical-digest',
  'absinthe:k334:recovery-marker:v1:canonical-digest',
  'absinthe:k334:audit-event:v1:canonical-digest',
  'absinthe:k334:authority-head:v1:projection-digest',
  'absinthe:k334:candidate-reference:v1:pair',
  'absinthe:k334:candidate-reference:v1:collection',
  'absinthe:k334:quarantine-basis-reference:v1:pair',
  'absinthe:k334:quarantine-basis-reference:v1:collection',
] as const);
