...
export function useNoteViewSidebarProps(input: UseNoteViewSidebarPropsInput): NoteViewSidebarProps {
  ...
  return useMemo(() => ({
    ...
    activeFolderId, activeTag, activeNoteCount, trashCount, starredCount, sidebarTodayCount, sidebarMonthCount, isTrash, noteListFilter, searchQuery, sidebarSearchQuery,
    ...
    activeNoteId, safeNotesForDatabase, dashboard, sortOrder, showSortMenu, dragNoteId,
    ...
    setShowShortcuts, setWorkspaceSearchOpen, openTraceDay, openTraceRange, openCreatedNote,
