...
export function useNoteViewSidebarProps(input: UseNoteViewSidebarPropsInput): NoteViewSidebarProps {
  ...
  return useMemo(() => ({
    ...
    activeFolderId, activeTag, activeNoteCount, trashCount, starredCount, sidebarTodayCount, sidebarMonthCount, isTrash, noteListFilter, searchQuery,
    ...
    importInputRef, setSidebarCollapsed, setActiveFolderId, setActiveTag, setSearchQuery,
