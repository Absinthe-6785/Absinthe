  ...
  return (
    <div
      ...
      className={layout === 'stack'
        ...
        : 'grid min-h-0 grid-cols-1 gap-2.5 lg:h-full lg:min-h-0 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.5fr)_minmax(0,1fr)] lg:items-stretch'}
    ...
    >
      {!visible ? (
        ...
        <>
          <div className="order-3 flex min-w-0 flex-col lg:order-1 lg:h-full lg:min-h-0">
          ...
          <div className={`${WORKSPACE_CARD.sm} ${WORKSPACE_CARD_SURFACE_COMPACT} order-1 flex min-w-0 flex-col px-3 py-2 transition-colors lg:order-2 lg:h-full lg:min-h-0 ${theme.card}`} data-inbody-panel>
          ...
          <div className="order-2 flex min-w-0 flex-col lg:order-3 lg:h-full lg:min-h-0">
            <ProteinTracker
              mode="compact"
              theme={theme}
