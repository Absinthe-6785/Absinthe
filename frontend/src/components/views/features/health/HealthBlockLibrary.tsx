...
export const HealthBlockLibrary = memo(function HealthBlockLibrary({
  ...
  return (
    <div
      className={`${WORKSPACE_CARD.sm} min-h-0 lg:h-[50%] lg:min-h-[300px] lg:max-h-[460px] ${WORKSPACE_CARD_SURFACE_COMPACT} flex flex-col overflow-hidden transition-colors ${theme.card} ${mobileVisible ? '' : 'hidden lg:flex'}`}
