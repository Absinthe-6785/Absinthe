  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onRestore}
        className="inline-flex items-center justify-start gap-1.5 min-h-[44px] lg:min-h-[32px] text-xs font-bold text-primary"
...
export function ArchiveSnapshotsSection({
  ...
  return (
    <ArchiveCollapsibleSection
      ...
      tone="utility"
    >
      <div data-k109-snapshots-grid>
        {snapshots.isEmpty ? (
          <p className={`text-xs py-1 ${theme.textMuted}`} data-k109-empty-state="snapshots">
