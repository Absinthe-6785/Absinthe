...
export function ArchiveRestoreToolsSection({
  ...
  return (
    ...
    >
      <div className="space-y-3" data-k109-restore-tools>
        <div className={`flex items-center gap-2 text-xs p-3 rounded-xl border ${theme.border} ${theme.input}`}>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-2">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 rounded-xl text-xs font-bold bg-primary text-primary-foreground"
          ...
          {canUndo && (
            <button
              type="button"
              onClick={() => undoRestore()}
              className="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 rounded-xl text-xs font-bold border"
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 rounded-xl text-xs font-semibold text-primary hover:underline"
