...
import { buildWorkspaceSearch } from './buildWorkspaceSearch';
...
describe('buildWorkspaceSearch', () => {
  ...
  it('finds projects and learning paths', () => {
    let project = setStudyProjectContainer(note('p1', 'EJU Prep'), 'active');
    let step = setLearningPathStep(note('s1', 'Step 1'), 'toefl-reading', 1);
