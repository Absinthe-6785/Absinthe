...
/** Tag-based subject organization surfaces — informational only. */
export function SubjectMapsDashboardPanel({ colors: c, subjects, onNavigateToNote }: SubjectMapsDashboardPanelProps) {
