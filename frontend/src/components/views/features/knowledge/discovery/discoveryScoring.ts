...
export const DISCOVERY_WEIGHTS = {
  ...
  WEAK_HUB_MIN_NOTES: 3,

  /** vault scan limits */
  FORGOTTEN_SCAN_LIMIT: 40,
  CONNECTION_SOURCE_LIMIT: 35,
  CONNECTIONS_PER_SOURCE: 2,
  EMERGING_SCAN_LIMIT: 80,
} as const;
