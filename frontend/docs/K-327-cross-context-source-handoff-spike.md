...
- direct candidate-store same-key/same-bytes idempotence and same-key/different-bytes collision injection, with full-binding validation, exact original-byte preservation, and zero overwrite/create/delete/rewrite mutation;
